...
if __name__ == '__main__':
	...
	parser.add_argument('-m', '--model-path',
		type=str,
		default='./yolo-coco/get_model.sh',
	...
	if FLAGS.download_model:
		subprocess.call(['./yolo-coco/get_model.sh'])
	...
	if FLAGS.image_path:
		...
		count = 0
		# Change the VideoCapture argument to 0 or 1 if the camera stream has a different enum value.
